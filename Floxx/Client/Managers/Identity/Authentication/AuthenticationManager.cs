...
using Floxx.Client.Authentication;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((FloxxStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((FloxxStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
        ...
        public async Task<string> RefreshToken()
        {
            ...
            var response = await _httpClient.PostAsync(Web.Client.Client.Routes.TokenEndpoint.Refresh, bodyContent);
